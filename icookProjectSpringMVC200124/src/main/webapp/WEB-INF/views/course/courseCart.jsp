				...
				<table class="table" id="tab2" style="width: 60%; max-width: 87%; margin-bottom: 20px;">
					...
					<c:choose>
						<c:when test="${!empty LoginOK.email}">
							<tr><td align='center'>Mail : <td><input type='text' size = '70' style='width: 70%' id='SAddress' name='ShippingAddress' value='${LoginOK.email}'  class='form-control' aria-describedby='basic-addon1'>
						</c:when>
						<c:otherwise>
