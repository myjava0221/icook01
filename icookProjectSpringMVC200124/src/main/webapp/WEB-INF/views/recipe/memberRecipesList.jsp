			...
			<c:forEach var="recipe" items="${recipes}">
				<div class="col-md-4 wthree_special_service_left" style="height: 400px">
					...
					<div class="wthree_more wthree_more2">
						<a href="<spring:url value='/recipes/updateRecipe?no=${recipe.recipeNo}' />" class="button--wayra button--border-thick button--text-upper button--size-s">Read More</a>
					</div>
				</div>
			</c:forEach>
				<div class="clearfix">
					<a href="${pageContext.request.contextPath}/recipes/add">新增食譜</a>
				 </div>
			</div>
		</div>
	</div>
