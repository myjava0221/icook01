					...
					<div class="form-group row">
						...
						<div class="col-sm-10">
							<form:input type="text" class="form-control" id="RecipeName"
								path="RecipeName" value="${recipe.recipeName}" />
						</div>
					</div>
					<div class="form-group row">
						...
						<div class="col-sm-10">
							<form:input type="text" class="form-control"
								id="RecipeDescription" path="description" value="${recipe.description}" />
						</div>
					</div>
				</div>
				<div class="w3_comments_bottom">
					...
					<table class="table" style="width: 90%">
						...
						<tbody>
							<tr>
								<td style="width: 50%"><form:input path="ingredNameList"
										type="text" class="form-control" placeholder="食材" /></td>
								<td style="width: 25%"><form:input path="ingredQtyList"
